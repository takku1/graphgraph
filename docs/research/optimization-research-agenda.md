> **Academic title:** Optimization Research Agenda  
> **Legacy name:** optimization-roadmap  
> **Incomplete items:** tracked in [open-work.md](../open-work.md) section D — do not treat this file as a second checklist
