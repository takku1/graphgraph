...
Per [`rigorous-framing.md`](../guides/evidence-standards.md): this is a research/ideas
...
[receiver type resolution](../architecture/static-analysis/receiver-type-inference.md), which applies its
