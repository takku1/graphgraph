...
* Modified symbols append revision-checked records to the delta log.
* Compaction incorporates additions and deletions into an atomic GGB4 base-file rewrite; relation queries can read the hot sections without materializing cold evidence.
