...
> [`rigorous-framing.md`](../guides/evidence-standards.md)'s rule ("write hypotheses
...
`docs/evaluation/empirical-evaluation.md`). This part of the analogy describes actual
