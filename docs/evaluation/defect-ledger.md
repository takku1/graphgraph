> **Academic title:** Defect Ledger  
> **Legacy name:** findings/BUGS.md  
> **Open follow-ups:** [open-work.md](../open-work.md) section B (sole incomplete checklist)  
> **Historical run logs:** [archive/.../findings/](graybox-cycles)
...
fixture issues under the archived `findings/fixtures/` tree are fixture-formatting issues and are
