...
Measured behavior, harnesses, and defect history. Incomplete **tasks** live in [../open-work.md](../open-work.md).
...
| [external-tool-interoperability-audit.md](external-tool-interoperability-audit.md) | External graph-tool audit |
| [swe-bench-protocol.md](swe-bench-protocol.md) | SWE-bench evaluation protocol |
