...
| --- | --- |
| [Global project attention](global_project_attention_research_proposal.md) | complete multiresolution cover, exact-near/compressed-far field, value-of-refinement, dynamic residual updates |
| [Dynamic surface math](dynamic_surface_math.md) | spreading activation, turn decay, density throttle, prefix stability |
| [Mathematical formulations](mathematical_formulations.md) | PPR, information-gain budget, relation quota, hub penalty |
| [Adaptive planning math](adaptive-planning-math.md) | query-class budget and planning rules |
| [Tensor context architecture](tensor_context_architecture.md) | CSR layout, spatial attention bias, temporal layer updates |
| [LLM-native context graph](llm-native-context-graph.md) | packet ladder, lexical/semantic hybrid retrieval, typed temporal graph semantics |
| [Advanced context engineering](advanced-context-engineering.md) | compiler passes, packet coarsening, inference, orchestration |
| [Semantic locality](semantic-locality-and-llm-efficiency.md) | structural locality and LLM efficiency claims |
| [Context maximization](context_graph_maximization_report.md) | serialization floors, full-corpus and graph baselines, hybrid fact injection |
| [Optimization roadmap](optimization-roadmap.md) | ranking, fusion, facet exploration, and early-termination candidates |
| [Metric and component gaps](metric-component-logic-gaps.md) | downstream code, ordering, multi-turn, scale, and tokenization tests |
| [kiminotes](kiminotes.md) and [follow-up](kiminotes-followup.md) | external research mechanisms not already represented above |
...
measurement:
[the coupling finding](findings/2026-07-29-influence-field-coupling.md).
...
[the recoupled verdicts](findings/2026-07-30-recoupled-cover-verdicts.md).
...
0. **Build a paraphrase/conceptual eval task set before tuning any field
   ...
   [the leverage finding](findings/2026-07-30-coupling-has-no-production-leverage.md).
