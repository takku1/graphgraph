...
[engineering](../engineering.md) and
[the 2.0 paper draft](../arxiv_paper_graphgraph_2.0.md). Large-magnitude claims
...
[metric/component logic gaps](../metric-component-logic-gaps.md) compared the
