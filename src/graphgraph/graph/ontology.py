...
DEFAULT_RELATIONS: dict[str, RelationSpec] = {
    ...
    "references": RelationSpec("references", "mention", strength=0.7, weak=True, description="Source mentions target."),
    ...
    "discusses": RelationSpec("discusses", "document", strength=0.65, weak=True, description="Source document section discusses target concept."),
