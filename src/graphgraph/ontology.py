...
DEFAULT_RELATIONS: dict[str, RelationSpec] = {
    ...
    "references": RelationSpec("references", "mention", strength=0.45, weak=True, description="Source mentions target."),
    ...
    "section_of": RelationSpec("section_of", "document", strength=0.75, description="Source section belongs to target document."),
