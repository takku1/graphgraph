"""Graph expansion: paths, blast radius, evidence reservation, and edge budgeting."""
...
from ..planning import ContextPlan, compute_subgraph_stats
from ..planning.shape import LOCAL_EDGE_DENSITY_CAP
