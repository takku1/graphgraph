...
| OW-AC-03 | ≥80% full recall on conceptual / lexically disjoint tasks with no exact-task regression | ready | — | [Structural Retrieval](docs/architecture/information-retrieval/structural-retrieval/SYSTEM.md) — local 1.0 (3/3); in-repo fixture 1.0 (5/5 + red abstain); locus clone 4/7 (C03–C06) at HEAD 3de12f6, not the pinned 76d80f99 checkout; NEED_CHECKER |
