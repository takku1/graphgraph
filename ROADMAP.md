...
| R-005 | Conceptual fixture disjointness is weaker than claimed | ready | `eval/conceptual-fixture.json` — the disjointness assertion compares query tokens against the *identifier* only, while each fixture docstring is a near-verbatim restatement of its query. The suite currently measures docstring-keyword retrieval with the identifier elided, not paraphrase. Raised by the OW-AC-03 checker 2026-08-18 |
...
| OW-AC-03 | ≥80% full recall on conceptual / lexically disjoint tasks with no exact-task regression | ready | — | [Structural Retrieval](docs/architecture/information-retrieval/structural-retrieval/SYSTEM.md) — local 1.0 (3/3); in-repo fixture **0.80 (4/5)**, FIX-C03 a measured miss, plus red abstain; locus clone 4/7 (C03–C06) at HEAD 3de12f6, not the pinned 76d80f99 checkout. Independent checker 2026-08-18: KEEP, exact-task and abstention invariants reproduced, full suite 0 failures. Two caveats it raised are tracked as R-003 and R-005 |
